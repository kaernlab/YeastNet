...
image_path = './Validation/' + str(num) + 'Pred.png'
raw_image_path = './Validation/' + str(num) + 'IMG.png'
image = load_image(image_path)
raw_image = load_image(raw_image_path)
raw_image = np.dstack((raw_image,raw_image,raw_image))
raw_image = np.reshape(raw_image, (512,512,3)) 
...
for idx in range(1,num_labels):
    ...
    x = cv2.drawContours(raw_image, contour, -1, (255,0,0), 1)
